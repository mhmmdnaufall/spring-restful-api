...
/**
 * Notes
 * Controller itu kyk semacam "penghubung"
 * berususan dengan jalur/penghubung ke view, database, dll
...
public class ProductController {
    ...
    public ResponseEntity<ResponseData<Product>> create(
        ...
        return insertToDatabase(product, errors);
    ...
    public ResponseEntity<ResponseData<Product>> insertToDatabase(Product product, Errors errors) {
